...
from python.config import ori_n_h, ori_n_v, ori_n_c
...
class ImageLoader():
    ...
    def load_train_image(self, train_path):
        X_train = np.zeros((n_train, ori_n_h, ori_n_v, 1))
        Y_train = np.zeros((n_train, ori_n_h, ori_n_v, 1))
        label_train = []
    ...
    def load_test_image(self,test_path):
        X_test = np.zeros((n_test, ori_n_h, ori_n_v, ori_n_c))
        label_test = []
